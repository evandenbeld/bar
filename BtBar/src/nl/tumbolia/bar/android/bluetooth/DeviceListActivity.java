...
public class DeviceListActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		initializeAdaptersArrays();

		setupPairedDevicesListView();
		setupNewlyDiscoveredDevicesListView();
	...
	private void setupNewlyDiscoveredDevicesListView()
	{
	...
	private void initializeAdaptersArrays()
	{
	...
	void doDiscovery()
	{
		...
		findViewById(R.id.btProgressBar).setVisibility(View.VISIBLE);
		...
		public void onReceive(Context context, Intent intent)
		{
			...
			if (BluetoothDevice.ACTION_FOUND.equals(action))
			{
				...
				// When discovery is finished, change the Activity title
					...
					.equals(action))
			{
				findViewById(R.id.btProgressBar).setVisibility(View.GONE);
